...
const ruleName = 'oas3-request-header-if-none-match-is-string';
...
describe(ruleName, () => {
  ...
  test('should fail a request If-None-Match header that is not a string', async () => {
  ...
  test('should pass a request If-None-Match header that is a string', async () => {
