...
const ruleName = 'oas3-path-based-versioning-major-only';
...
describe(ruleName, () => {
  ...
  test('should detect if there are revision numbers in the version - oas3', async () => {
  ...
  test('should pass for valid version - oas3', async () => {
