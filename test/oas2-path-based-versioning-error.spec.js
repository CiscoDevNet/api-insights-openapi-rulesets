...
const ruleName = 'oas2-path-based-versioning-error';
...
describe(ruleName, () => {
  ...
  test('should detect if there is no path-based versioning - oas2', async () => {
  ...
  test('should pass for valid path-based versioning - oas2', async () => {
