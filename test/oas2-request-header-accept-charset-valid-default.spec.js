...
const ruleName = 'oas2-request-header-accept-charset-valid-default';
...
describe(ruleName, () => {
  ...
  test('should fail a request Accept-Charset header where the default value is not some variation of "utf-8"', async () => {
  ...
  test('should pass a request Accept-Charset header where the default value is some variation of "utf-8"', async () => {
