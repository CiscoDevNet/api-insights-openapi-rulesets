...
const ruleName = 'oas3-request-header-accept-charset-default-required';
...
describe(ruleName, () => {
  ...
  test('should fail a request Accept-Charset header that has no default value', async () => {
    ...
    expect(res).toEqual([
      {
        code: ruleName,
        message: 'HTTP headers follow the syntax specified in the corresponding RFCs.; "schema.default" property must be truthy',
        path: [
          'paths',
          '/test',
          'get',
  ...
  test('should pass a request Accept-Charset header that does have a default value', async () => {
