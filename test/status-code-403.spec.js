...
const ruleName = 'status-code-403';
...
describe(ruleName, () => {
  ...
  test('should throw an error if security is set, but no 403', async () => {
    ...
    expect(res).toEqual([
      {
        ...
        message: 'A 403 status code is returned if a consumer is not authorized to access an operation.',
        path: [
          'paths',
          '/myResource',
          'put',
  ...
  test('should pass with provided 403 response', async () => {
