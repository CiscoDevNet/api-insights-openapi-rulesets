...
const ruleName = 'oas3-request-header-accept-language-enum';
...
describe(ruleName, () => {
  ...
  test('should fail a request Accept-Language header that does not accept an enum', async () => {
    ...
    expect(res).toEqual([
      {
        code: ruleName,
        message: 'HTTP headers follow the syntax specified in the corresponding RFCs.; "schema.enum" property must be truthy',
        path: [
          'paths',
          '/test',
          'get',
