...
const ruleName = 'oas2-post-201-created';
...
describe(ruleName, () => {
  ...
  test('should throw an error if POST 201 does not have contents', async () => {
    ...
    expect(res).toEqual([
      {
        code: ruleName,
        message: 'POST operations which create objects return 201 Created, with a full or reference-only representation.; "[201].schema" property must be truthy',
        path: [
          'paths',
          '/test',
          'post',
