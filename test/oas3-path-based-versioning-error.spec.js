...
const ruleName = 'oas3-path-based-versioning-error';
...
describe(ruleName, () => {
  ...
  test('should detect if there is no path-based versioning - oas3', async () => {
  ...
  test('should pass for valid path-based versioning - oas3', async () => {
