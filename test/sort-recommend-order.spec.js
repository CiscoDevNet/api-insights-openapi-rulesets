...
const ruleName = 'sort-recommend-order';
...
describe(ruleName, () => {
  ...
  test('should suggest to add "order" query parameter to "sort"', async () => {
  ...
  test('should not suggest to add "order" to "sort" if "order" already exists', async () => {
