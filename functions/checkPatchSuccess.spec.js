...
import checkPatchSuccess from './checkPatchSuccess.js';
const errorMsg = 'PATCH operations return either \'200 OK\' with full representation or \'204 No Content\'.';

describe('checkPatchSuccess', () => {
  test('should check for 200 OK and representation in an OAS3 document', () => {
    const res = checkPatchSuccess({
      requestBody: {
        content: {
          'application/json': {
            type: 'dummy',
  ...
  test('full response schema equals full request schema', () => {
    const res = checkPatchSuccess({
      requestBody: {
        content: {
          'application/json': {
  ...
  test('partial response schema found in full request schema', () => {
    const res = checkPatchSuccess({
      requestBody: {
        content: {
          'application/json': {
