...
|-----------------------------------------------|-----------------------------------------------------------------------------|--------|--------------------------------------------------------|
|oas[2/3]-schema                                |Malformed OAS document, not adhering to the OpenAPI v2/v3 specifications.   |error   |Please fix the items identified to adhere to the OpenAPI v2/v3 specifications. [Reference](https://testing-developer.cisco.com/docs/api-insights/#!api-doc-completeness-analyzer)                                     |
|oas-version                                    |The version of OpenAPI is not specified.                                    |error   |Please add the OpenAPI attributes identified as missing and provide values for these attributes. [Reference](https://testing-developer.cisco.com/docs/api-insights/#!api-doc-completeness-analyzer)                   |
|info-contact                                   |Info object must have `contact` object.                                     |warning |Please add missing `contact` object. [Reference](https://testing-developer.cisco.com/docs/api-insights/#!api-doc-completeness-analyzer)                                                                               |
|info-description                               |Info object must have a non-empty `description`.                            |warning |Please add missing `description`. [Reference](https://testing-developer.cisco.com/docs/api-insights/#!api-doc-completeness-analyzer)                                                                                  |
|info-license                                   |Info object must have `license` object.                                     |warning |Please add missing `license` object. [Reference](https://testing-developer.cisco.com/docs/api-insights/#!api-doc-completeness-analyzer)                                                                               |
|license-url                                    |License object must have a `url`.                                           |warning |Please add missing `url`. [Reference](https://testing-developer.cisco.com/docs/api-insights/#!api-doc-completeness-analyzer)                                                                                          |
|oas[2/3]-missing-schema-definition             |Some schema definitions are missing.                                        |error   |Please add schema definitions for the items detected. [Reference](https://testing-developer.cisco.com/docs/api-insights/#!api-doc-completeness-analyzer)                                                              |
|general-schema-defination                      |Some schemas are partially defined.                                         |error   |Please fully describe the schema for the items detected as using object. [Reference](https://testing-developer.cisco.com/docs/api-insights/#!api-doc-completeness-analyzer)                                           |
|oas[2/3]-missing-returned-representation       |Some responses do not define a schema.                                      |error   |Please add a schema for the items detected. [Reference](https://testing-developer.cisco.com/docs/api-insights/#!api-doc-completeness-analyzer)                                                                        |
|success-status-code                            |Some operations do not define a success status code.                        |error   |Please add a success status code in the 1xx, 2xx or 3xx range for the items identified. [Reference](https://testing-developer.cisco.com/docs/api-insights/#!api-doc-completeness-analyzer)                            |
|error-status-code                              |Some operations do not define errors.                                       |warning |Please add an error status code for the items identified. [Reference](https://testing-developer.cisco.com/docs/api-insights/#!api-doc-completeness-analyzer)                                                          |
|description-for-every-attribute                |Some attributes do not provide a description.                               |warning |Please add a description for the items identified. [Reference](https://testing-developer.cisco.com/docs/api-insights/#!api-doc-completeness-analyzer)                                                                 |
|examples-for-every-schema                      |Examples are not provided for some of the schemas.                          |warning |Please add examples for the schemas identified. [Reference](https://testing-developer.cisco.com/docs/api-insights/#!api-doc-completeness-analyzer)                                                                    |
